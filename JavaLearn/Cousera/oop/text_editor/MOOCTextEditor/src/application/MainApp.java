...
public class MainApp extends Application {
	...
	// MAIN
	/* code to run in cmd prompt
	C:\Program Files\Java\jdk-14.0.1\bin\java.exe --module-path "C:\Program Files\Java\javafx-sdk-14.0.2.1\lib" --add-modules=javafx.controls,javafx.fxml -XX:+ShowCodeDetailsInExceptionMessages -Dfile.encoding=UTF-8 @C:\Users\tanis\AppData\Local\Temp\cp_d197upu8hrwyc5ryanbrjnr2t.argfile application.MainApp
	*/
